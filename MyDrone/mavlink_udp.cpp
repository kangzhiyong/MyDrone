...
mavudp::mavudp(std::string device, bool input, bool broadcast, int source_system, int source_component, bool use_native)
{
    std::string ip = "127.0.0.1";
    int port = 14550, val = 1;
    std::vector<std::string> ip_Port = SLR::Split(device, ':');
    if (ip_Port.size() != 2)
    {
